      ...
      <form onSubmit={handleSubmit} className="bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="p-6 bg-gray-50 border-t flex justify-end gap-4">
          <button
            type="button"
            onClick={() => navigate('/admin/branchlist')}
            className="bg-white border border-gray-300 text-gray-700 hover:bg-gray-100 font-bold py-2 px-6 rounded shadow-sm transition"
          >
            Hủy
          </button>
          <button
            type="submit"
            disabled={loading}
            className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-8 rounded shadow-md transition disabled:opacity-50"
          >
